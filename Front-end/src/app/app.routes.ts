...
const appRoutes: Routes = [
    ...
    { path: 'cadastrar',
        children: [
            { path: '', component: HomeComponent },
            { path: 'jogo', component: GamesRegisterComponent },
            { path: 'fabricante', component: ManufacturesRegisterComponent },
            { path: 'plataforma', component: PlatformsRegisterComponent },
            { path: 'usuario', component: UsersRegisterComponent },
            { path: '**', component: HomeComponent }
        ]
    },
    ...
    { path: 'editar',
        children: [
            { path: '', component: HomeComponent },
            { path: 'jogo/:id', component: GameEditComponent },
            { path: 'fabricante/:id', component: ManufactureEditComponent },
            { path: 'plataforma/:id', component: PlatformEditComponent },
